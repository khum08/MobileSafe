...
public class CartView extends View {
    ...
    private void initAttr(Context context, @Nullable AttributeSet attrs) {
        ...
        mCart_background = typedArray.getColor(R.styleable.CartView_cart_background, Color.parseColor("#32ce69"));
        mText = typedArray.getString(R.styleable.CartView_text).toString();
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.CartView_textSize, sp2px(14));
        mTextColor = typedArray.getColor(R.styleable.CartView_textColor, Color.parseColor("#111111"));
        typedArray.recycle();
    }
