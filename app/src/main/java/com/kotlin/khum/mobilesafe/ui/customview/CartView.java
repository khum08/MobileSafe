...
public class CartView extends View {
    ...
    private void initAttr(Context context, @Nullable AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CartView);
        mCircleColor = typedArray.getColor(R.styleable.CartView_svc_circleColor, Color.parseColor("#aaaaaa"));
        mRightColor = typedArray.getColor(R.styleable.CartView_svc_rightColor, Color.parseColor("#13ab48"));
        mTextColor = typedArray.getColor(R.styleable.CartView_svc_textColor, Color.parseColor("#666666"));
        mPlusColor = typedArray.getColor(R.styleable.CartView_svc_plus_color, Color.parseColor("#ffffff"));
        mText = typedArray.getString(R.styleable.CartView_svc_text);
        mQuantity = Integer.parseInt(mText);
        mTextSize = typedArray.getDimension(R.styleable.CartView_svc_textSize, sp2px(14));
        typedArray.recycle();
    }
    ...
    interface QuantityChangedListener{
        void quantityChanged(CartView subCartView, int quantity, boolean isIncrease);
    }
